...
const registeredTools = (await Promise.all(['usePrismLibraryTools.ts', 'useDocumentIntelligenceTools.ts', 'useTopicTools.ts'].map(name => readFile(new URL(`../apps/web/src/webmcp/${name}`, import.meta.url), 'utf8'))))
